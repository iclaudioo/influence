      ...
      <form onSubmit={handleSubmit} className={`space-y-3 ${className}`}>
        ...
        <div className="flex gap-2">
          <input
            ...
            required
            className="flex-1 rounded-lg border border-white/20 bg-white/5 px-3 py-2 text-sm text-white placeholder:text-white/40 focus:border-white/40 focus:outline-none transition-colors"
          />
          <Button
            type="submit"
            variant="primary"
          ...
          >
            {formState === "submitting" ? "..." : t("newsletterButton")}
          </Button>
        </div>
