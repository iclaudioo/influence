        ...
        <Container>
          <div className="mx-auto max-w-3xl">
            ...
            <nav className="mb-8 flex items-center gap-2 text-sm text-white/40">
              <a href={`/${locale === "nl" ? "" : "en"}`} className="hover:text-white/60 transition-colors">
                Home
              </a>
              <span>/</span>
              <a href={`/${locale === "nl" ? "" : "en/"}blog`} className="hover:text-white/60 transition-colors">
                Blog
              </a>
              <span>/</span>
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-lg border border-white/10 p-2 text-white/50 transition-colors hover:border-white/20 hover:text-white"
              ...
              <button
                type="button"
                className="copy-link-btn rounded-lg border border-white/10 p-2 text-white/50 transition-colors hover:border-white/20 hover:text-white"
                data-url={articleUrl}
